...
export default {
  ...
  data: function () {
    return {
      ...
      fields: ["1", "1000"],
      typesOfFields: [
        { name: "Метры", shortName: "м", coef: "10" },
        { name: "Миллиметры", shortName: "мм", coef: "10" },
      ],
      types: [
        { name: "Миллиметры", shortName: "мм", coef: "10" },
        { name: "Сантиметры", shortName: "см", coef: "10" },
        { name: "Дециметры", shortName: "дм", coef: "10" },
        { name: "Метры", shortName: "м", coef: "10" },
        { name: "Фут", shortName: "ф", coef: "0.3047999902464003" },
        { name: "Дюйм", shortName: "д", coef: "0.0833333333333333" },
        { name: "Километры", shortName: "км", coef: "39370.00000000248" },
      ],
    };
  },
  methods: {
