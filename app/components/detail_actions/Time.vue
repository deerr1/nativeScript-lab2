...
export default {
  ...
  data: function () {
    return {
      ...
      fields: ["1", "60"],
      typesOfFields: [
        { name: "Минуты", shortName: "мин", coef: "60" },
        { name: "Секунды", shortName: "s", coef: "60" },
      ],
      types: [
        { name: "Секунды", shortName: "s", coef: "60" },
        { name: "Минуты", shortName: "мин", coef: "60" },
        { name: "Часы", shortName: "ч", coef: "60" },
        { name: "Дни", shortName: "d", coef: "24" },
        { name: "Недели", shortName: "wk", coef: "7" },
        { name: "Годы", shortName: "y", coef: "52.14285714285714" },
      ],
    };
  },
  methods: {
