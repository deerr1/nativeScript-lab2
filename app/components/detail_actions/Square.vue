...
export default {
  ...
  data: function () {
    return {
      ...
      fields: ["1", "10000"],
      typesOfFields: [
        { name: "Квадратные метры", shortName: "м2", coef: "100" },
        { name: "Квадратные сантиметры", shortName: "см2", coef: "100" },
      ],
      types: [
        { name: "Квадратные миллиметры", shortName: "мм2", coef: "100" },
        { name: "Квадратные сантиметры", shortName: "см2", coef: "100" },
        { name: "Квадратные дециметры", shortName: "дм2", coef: "100" },
        { name: "Квадратные метры", shortName: "м2", coef: "100" },
        { name: "Ары", shortName: "а", coef: "100" },
        { name: "Гектары", shortName: "ha", coef: "100" },
        { name: "Квадратные километры", shortName: "км2", coef: "100" },
      ],
    };
  },
  methods: {
